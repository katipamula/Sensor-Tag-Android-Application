...
import com.example.nitin.sensortagandroid.sections.LightFragment;
import com.example.nitin.sensortagandroid.sections.TemperatureFragment;
...
public class SensorTagActivity extends FragmentActivity implements ConfigurationDialogFragment.OnLeConnectionRequestHandler{
    private static final String TAG = "com.example.nitin.sensortagandroid";

    public static final int SECTION_NUMBER_TEMPERATURE = 0;
    public static final int SECTION_NUMBER_LIGHT = 1;
    public static final int SECTION_NUMBER_TOTAL = 2;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case SECTION_NUMBER_LIGHT:
                    Fragment lightFragment = new LightFragment();
                    lightFragment.setArguments(args);
